...
class LlamaChat:
    def __init__(self, model_name: Optional[str] = None, n_threads: Optional[int] = None):
    ...
    def _format_prompt(self, user_input: str) -> str:
        ...
        formatted.append(f"{pf.assistant_prefix}")  # Start assistant response
    ...
    def chat(self):
        print(f"\nWelcome to LlamaChat! Using model: {self.model_config.model_name}")
...
if __name__ == "__main__":
    ...
    try:
        chat = LlamaChat(model_name=args.model_name, n_threads=args.n_threads)
        chat.chat()
    except Exception as e:
        print(f"Error: {str(e)}")